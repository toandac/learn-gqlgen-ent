...
func (uq *UserQuery) QueryArticles() *ArtcileQuery {
	query := &ArtcileQuery{config: uq.config}
...
func (uq *UserQuery) WithArticles(opts ...func(*ArtcileQuery)) *UserQuery {
	query := &ArtcileQuery{config: uq.config}
...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	if query := uq.withArticles; query != nil {
		...
		for i := range nodes {
			...
			nodes[i].Edges.Articles = []*Artcile{}
		}
		query.withFKs = true
		query.Where(predicate.Artcile(func(s *sql.Selector) {
