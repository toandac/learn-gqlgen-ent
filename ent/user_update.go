...
// AddArticles adds the "articles" edges to the Artcile entity.
func (uu *UserUpdate) AddArticles(a ...*Artcile) *UserUpdate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
// ClearArticles clears all "articles" edges to the Artcile entity.
func (uu *UserUpdate) ClearArticles() *UserUpdate {
	uu.mutation.ClearArticles()
	return uu
}

// RemoveArticleIDs removes the "articles" edge to Artcile entities by IDs.
func (uu *UserUpdate) RemoveArticleIDs(ids ...int) *UserUpdate {
	uu.mutation.RemoveArticleIDs(ids...)
	return uu
}

// RemoveArticles removes "articles" edges to Artcile entities.
func (uu *UserUpdate) RemoveArticles(a ...*Artcile) *UserUpdate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
// AddArticles adds the "articles" edges to the Artcile entity.
func (uuo *UserUpdateOne) AddArticles(a ...*Artcile) *UserUpdateOne {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
// RemoveArticles removes "articles" edges to Artcile entities.
func (uuo *UserUpdateOne) RemoveArticles(a ...*Artcile) *UserUpdateOne {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
