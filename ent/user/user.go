...
const (
	...
	ArticlesTable = "artciles"
	// ArticlesInverseTable is the table name for the Artcile entity.
	// It exists in this package in order to avoid circular dependency with the "artcile" package.
	ArticlesInverseTable = "artciles"
